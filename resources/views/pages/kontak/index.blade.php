...
@section('content')
<div class="mb-6"><h1 class="text-3xl font-bold text-gray-800">Kontak</h1></div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center space-x-4">
            ...
            <div><h3 class="font-bold text-lg">Telepon</h3><p class="text-gray-600">(0431) 863327</p></div>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-lg p-8">
        <div class="flex items-center space-x-4">
            ...
            <div><h3 class="font-bold text-lg">Email</h3><p class="text-gray-600">bps7100@bps.go.id</p></div>
        </div>
    </div>
</div>
@endsection
