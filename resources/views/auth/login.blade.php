...
<body class="gradient-bps min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        <div class="gradient-bps p-8 text-center">
            <img src="{{ asset('assets/images/logo_bps.png') }}" alt="BPS" class="h-16 w-16 object-contain mx-auto mb-3">
        ...
        <div class="p-8">
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('home') }}" class="text-blue-600 hover:underline text-sm">← Kembali ke Beranda</a>
            </div>
        </div>
    </div>
    <script>
